...
def open_bit_plane_window(file_path, original_grayscale): 
    ...
    def watermark_to_RGB(file):     
        ...
        output_path = os.path.join(TEMP_DIR, "watermark.png")
        ...
        if(file_name.split(".")[1] == "png"):    # check if image is in PNG format [1] [2]
            ...
            background.save(output_path, 'PNG')       # save the converted into a png file 
            ...
            RGB_image.save(output_path)           # save the converted into a png file
    ...
    def open_PCX(file):   # function for opening an image
        ...
        if(file_name.split(".")[1] == "pcx"):    # check if image is not in PCX format
            with open(file, 'rb') as f:     # read the image as binary
                ...
                imageData.save(os.path.join(TEMP_DIR, "watermark.png"))
    ...
    def bit_plane_slicing(number, bit_plane_list):
        ...
        output_path = os.path.join(TEMP_DIR, "bit_plane_slice.png")
    ...
    second_column = [               
        ...
        [sg.Image(key="-first_image-", pad = ((0, 0), (0, 10)), size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   # image element
        [sg.Text("Bit Plane 4:", key='fifth', size = (40, 1), text_color = "yellow", justification = 'center')],     
        [sg.Image(key="-fifth_image-", size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   
        [sg.Text("Watermarked Image:", key='watermark', size = (40, 1), text_color = "yellow", justification = 'center')],     
        [sg.Image(key="-watermark_image-", size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   
    ]

    third_column = [
        [sg.Text("Bit Plane 1:", key='second', size = (40, 1), pad=((0, 0), (0, 4)), text_color = "yellow", justification = 'center')],    
        [sg.Image(key="-second_image-", pad = ((0, 0), (0, 10)), size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   # image element
        [sg.Text("Bit Plane 5:", key='sixth', size = (40, 1), text_color = "yellow", justification = 'center')],     
        [sg.Image(key="-sixth_image-", size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   
    ]

    fourth_column = [
        [sg.Text("Bit Plane 2:", key='third', size = (40, 1), pad=((0, 0), (0, 4)), text_color = "yellow", justification = 'center')],    
        [sg.Image(key="-third_image-", pad = ((0, 0), (0, 10)), size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   # image element
        [sg.Text("Bit Plane 6:", key='seventh', size = (40, 1), text_color = "yellow", justification = 'center')],     
        [sg.Image(key="-seventh_image-", size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   
    ]

    fifth_column = [
        [sg.Text("Bit Plane 3:", key='fourth', size = (40, 1), pad=((0, 0), (0, 4)), text_color = "yellow", justification = 'center')],    
        [sg.Image(key="-fourth_image-", pad = ((0, 0), (0, 10)), size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   # image element
        [sg.Text("Bit Plane 7:", key='eighth', size = (40, 1), text_color = "yellow", justification = 'center')],     
        [sg.Image(key="-eighth_image-", size = (320, 240), filename=os.path.join(ASSETS_DIR, "empty.png"))],   
    ]
    ...
    transformation("first", "-first_image-", "Bit Plane 0:", os.path.join(TEMP_DIR, "bit_plane_slice.png"))
    ...
    while True:
        ...
        if event == "Exit" or event == sg.WIN_CLOSED:
            ...
            transformation("second", "-second_image-", "Bit Plane 1:", os.path.join(TEMP_DIR, "bit_plane_slice.png"))

            bit_plane_slicing(4, bit_plane_list)
            transformation("third", "-third_image-", "Bit Plane 2:", os.path.join(TEMP_DIR, "bit_plane_slice.png"))

            bit_plane_slicing(8, bit_plane_list)
            transformation("fourth", "-fourth_image-", "Bit Plane 3:", os.path.join(TEMP_DIR, "bit_plane_slice.png"))

            bit_plane_slicing(16, bit_plane_list)
            transformation("fifth", "-fifth_image-", "Bit Plane 4:", os.path.join(TEMP_DIR, "bit_plane_slice.png"))

            bit_plane_slicing(32, bit_plane_list)
            transformation("sixth", "-sixth_image-", "Bit Plane 5:", os.path.join(TEMP_DIR, "bit_plane_slice.png"))

            bit_plane_slicing(64, bit_plane_list)
            transformation("seventh", "-seventh_image-", "Bit Plane 6:", os.path.join(TEMP_DIR, "bit_plane_slice.png"))

            bit_plane_slicing(128, bit_plane_list)
            transformation("eighth", "-eighth_image-", "Bit Plane 7:", os.path.join(TEMP_DIR, "bit_plane_slice.png"))
            ...
            if file_path == "":
                ...
                image = cv2.imread(os.path.join(TEMP_DIR, "watermark.png"))   #   cv2.imread() returns a BGR (Blue-Green-Red) array
                ...
                cv2.imwrite(os.path.join(TEMP_DIR, "watermark.png"), grayscale)     
                ...
                if ((grayscale.shape) != (bit_plane_list[0].shape)):      # stop program if chosen watermark is not of the same dimensions as bit plane zero
                    ...
                    cv2.imwrite(os.path.join(TEMP_DIR, "watermark_image.png"), full_image)
                    
                    transformation("first", "-first_image-", "Replaced Bit Plane 0:", os.path.join(TEMP_DIR, "watermark.png"))
                    transformation("watermark", "-watermark_image-", "Watermarked Image:", os.path.join(TEMP_DIR, "watermark_image.png"))
